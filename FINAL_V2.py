...
def alpha_beta_search_2player(position, depth, alpha, beta, max_player, game, color):
    ...
    if color == WHITE:
        if depth == 0 or position.get_winner() != None:
            white_score = self.white_pieces_left + (self.white_queens * 0.5)
            black_score = self.black_pieces_left + (self.black_queens * 0.5)
...
get_row_col_from_mouse = lambda pos: (pos[1] // SQUARE_SIZE, pos[0] // SQUARE_SIZE)
...
def get_game_settings():
    ...
    while True:
        ...
        if choix.lower() == 'o':
            ...
            while True:
                ai_level_1_input = input("\n Veuillez choisir le niveau de difficulté de la 1ère IA :\n\n - Facile : tapez (1)\n - Intermédiaire : tapez (2)\n - Difficile : tapez (3)\n\n Quel est votre choix ? ")
                ai_level_2_input = input("\n Veuillez choisir le niveau de difficulté de la 2ème IA :\n\n - Facile : tapez (1)\n - Intermédiaire : tapez (2)\n - Difficile : tapez (3)\n\n Quel est votre choix ? ")
                try:
...
def handle_mouse_input(partie):
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            line, col = get_row_col_from_mouse(pos)
